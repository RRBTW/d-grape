 ...
 *
 *  Архитектура v2:
 *    - Кинематика (Twist→wheel speeds) перенесена на ПК
 *    - STM32 принимает wheel_cmd напрямую [м/с]
 *    - PID встроен в motors.c
 *    - IMU: MPU-6050 по I2C1
 *    - Фильтр Калмана: velocity + yaw fusion (IMU + encoder)
 * ============================================================ */

#include "stm32f4xx_hal.h"

/* ── Физические параметры робота ────────────────────────────
 *  Используются в KF и encoders, НЕ для кинематики (она на ПК)
 * ────────────────────────────────────────────────────────── */
